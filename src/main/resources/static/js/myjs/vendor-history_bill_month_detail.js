...
var VendorHistoryBillMonthDetail = function () {
        ...
        init: function () {
            ...
            $("#add_btn").on("click",function () {
                ...
                swal({
                    ...
                    $.ajax({
                        type: "post",
                        url: "/finance/vendor-history-bill/detail/add",
                        data: {"vid": vid, "aid":add_aid,"cost": add_cost, "amount": add_amount,"yearMonth": add_cyc},
                        dataType: "json",
                        beforeSend:function () {
                            openProgress();
                        },
            ...
            $("#del").on('click',function () {
                ...
                if (id == null || id == ""){
                    ...
                    $.ajax({
                        type: "post",
                        url: "/finance/vendor-history-bill/detail/batch-check-lock",
                        data: {"id": id},
                        dataType: "json",
                        success: function (data) {
                            if (data != null) {
            ...
            $("#lock").on('click',function () {
                ...
                if (id == null || id == ""){
                    ...
                    swal({
                        ...
                        $.ajax({
                            type:'post',
                            url:"/finance/vendor-history-bill/detail/lock",
                            data:{"id": id},
                            dataType:"json",
                            beforeSend:function () {
                                openProgress();
            ...
            $("#unlock").on('click',function () {
                ...
                if (id == null || id == ""){
                    ...
                    swal({
                        ...
                        $.ajax({
                            type:'post',
                            url:"/finance/vendor-history-bill/detail/unLock",
                            data:{"id": id},
                            dataType:"json",
                            beforeSend:function () {
                                openProgress();
