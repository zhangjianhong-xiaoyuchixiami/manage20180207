                        ...
                        <div class="portlet-body no-more-tables">
                            ...
                            <div class="clearfix margin-bottom-20">
                                ...
                                <div class="control-group pull-left">
                                    ...
                                    <label class="control-label">本页总计&yen;：<#if lineSizeTotleAmount??><span>${lineSizeTotleAmount}元</span><#else ><span>0元</span></#if></label>
                            ...
                            <div class="row-fluid">
                                ...
                                <div class="span6">
                                    ...
                                    <div class="dataTables_info" id="sample_1_info">当前显示第 1 页 共 10 页</div>
