...
<@layout ; section>
        ...
        <div class="container-fluid">
            ...
            <div class="row-fluid">
                ...
                <#--搜索框-->
                    ...
                    <form action="/finance/find-all-customer/find-week-record-by-customer-id" class="form-bottom week_record" method="get">
    ...
    <script src="/js/myjs/week-record.js?v=${ver}"></script>

    <script src="/js/oldlocal/week-record.js?v=${ver}"></script>
