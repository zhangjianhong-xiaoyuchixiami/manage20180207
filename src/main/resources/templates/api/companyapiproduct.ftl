        ...
        <div class="container-fluid">
            ...
            <div class="row-fluid">
                ...
                <#--搜索框-->
                    ...
                    <form action="/api/api-message-by-company" class="api_company_product_record" method="get">
                                    ...
                                    <tbody>
                                        <#if companyApiList??>
                                            ...
                                            <tr>
                                                ...
                                                <td data-title="合作公司"><a href="/api/api-message-by-company?partnerId=${(company.partnerId)!''}">${(company.partnerName)!''}</a></td>
