                            ...
                            <div class="table-responsive">
                                <table class="table table-striped table-bordered table-hover table-condensed" id="sample_product_1">
                                    ...
                                    <tbody>
                                        <#if apiList??>
                                            <#list apiList as api>
                                                <#if api.api.cost==api.cost>
                                                <tr class="success">
                                                <#else >
                                                <tr>
                                                </#if>
                                                <td data-title="产品名称">${api.name}<#if api.api.name??>（调用：${api.api.name!''}）</#if></td>
                                                <td data-title="产品类型">${api.apiType.name}<#if api.mobileOperator??>--${api.mobileOperator.name!''}</#if></td>
